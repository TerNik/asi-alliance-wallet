...
// Синхронный CardanoAccount для AccountStore (заглушка или минимальный функционал)
export interface CardanoAccount {
  // Можно добавить поля, если нужно для совместимости
...
// Асинхронный CardanoAccountMixin оставляем для отдельных сценариев
