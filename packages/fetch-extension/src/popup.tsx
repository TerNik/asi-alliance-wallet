...
async function startApp() {
  ...
  const { CreateCardanoWallet } = await import('./ui/routes/CreateCardanoWallet');
                      ...
                      React.createElement(
                        ...
                        React.createElement(
                          ...
                          React.createElement(
                            ...
                            React.createElement(Route, { path: '*', element: React.createElement(StateRenderer) }),
                            React.createElement(Route, { path: '/cardano-wallet', element: React.createElement(CreateCardanoWallet) })
                          )
                        )
                      )
                    )
